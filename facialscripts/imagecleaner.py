...
def StraightenImage(img):
    ...
    prediction = dlib.shape_predictor("facialscripts/shape_predictor_5_face_landmarks.dat")
...
if __name__ == "__main__":
    ...
    img = Load_image("1000_F_267821132_OI65CowODwT5nqFAdBqVO8TNV08cOUDc.jpg")
